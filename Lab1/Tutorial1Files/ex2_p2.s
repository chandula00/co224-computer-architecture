...
main:
	...
	@ ---------------------
	add r2,r2,r3 // Register r2 contains r2+r3 (R=a[0]+a[1])
	sub r2,r2,#7 // Register r2 contains r2-7 (R-7)
    add r2,r2,#2 // Register r2 contains r2+2 (R+2)
	str r2,[r0,#8] // Store final value into a[2]
	@ ---------------------
